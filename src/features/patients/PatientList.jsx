...
export function PatientList({ refreshKey = 0, selectedId, onSelect }) {
  ...
  return (
    <section className="card patient-list">
      ...
      <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Buscar paciente, telefono, diagnostico..." />
      ...
      <div className="list-stack">
        {filtered.map((patient) => (
          ...
          >
            ...
            <small>{patient.functional_diagnosis || patient.medical_diagnosis || 'Sin diagnostico'}</small>
          </button>
        ))}
